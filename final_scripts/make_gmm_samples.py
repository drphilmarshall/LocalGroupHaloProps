...
# In[2]:
with open('/afs/slac.stanford.edu/u/ki/mwillia1/Thesis/LocalGroupHaloProps/L.pickle', 'rb') as Lfile:
    L = pickle.load(Lfile)

with open('/afs/slac.stanford.edu/u/ki/mwillia1/Thesis/LocalGroupHaloProps/Tr.pickle', 'rb') as Trfile:
