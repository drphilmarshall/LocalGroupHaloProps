...
path = '/afs/slac.stanford.edu/u/ki/mwillia1/All_Boxes_quad_dat_M31_larger.npy'
npoints = 200000
...
Tr.sim_samples = Tr.sim_samples[:,0:3]
...
path = '/afs/slac.stanford.edu/u/ki/mwillia1/Thesis/LocalGroupHaloProps/Tr_PE_samp.pickle'
